...
PKG_SUMMARY   = 'An extensible REST-based digital asset management server.'
...
EXTRA_PKGFILES.include( "#{BASEDIR}/etc/thingfish.conf.*" )
EXTRA_PKGFILES.include( "#{BASEDIR}/QUICKSTART" )
EXTRA_PKGFILES.include( "#{BASEDIR}/run" )
EXTRA_PKGFILES.include( "#{BASEDIR}/var/www/**/*.rhtml" )
EXTRA_PKGFILES.include( "#{BASEDIR}/var/www/static/*.{png,jpg,gif,css,js}" )
