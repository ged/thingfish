...
class TextileFilter < Manual::Filter
...
class ErbFilter < Manual::Filter
	
	### Process the given +source+ as ERB and return the resulting HTML
	### fragment.
	def process( sourcefile, page, metadata )
		template_name = source.basename
...
class ExamplesFilter < Manual::Filter
